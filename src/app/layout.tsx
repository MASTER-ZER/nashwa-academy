        ...
        <ThemeProvider>
          ...
          <header className="sticky top-0 z-40 px-2 sm:px-6 py-2.5 sm:py-3 no-print">
            <div className="max-w-7xl mx-auto h-14 sm:h-16 rounded-2xl liquid-glass px-3 sm:px-6 flex items-center justify-between gap-2 border border-white/40 dark:border-cyan-500/20">
              ...
              <Link href="/" className="flex items-center gap-2 sm:gap-3 group active:scale-95 transition-transform shrink-0">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-gradient-to-tr from-brand-600 via-cyan-500 to-brand-400 text-white flex items-center justify-center shadow-md shadow-cyan-500/20 group-hover:scale-105 transition-transform shrink-0">
