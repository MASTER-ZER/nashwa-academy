...
export default function HomePage() {
  ...
  return (
    <div className="space-y-10 py-2">
      ...
      {activeStudent && (
        <div className="p-4 sm:p-5 rounded-3xl liquid-glass border border-emerald-500/30 bg-emerald-50/40 dark:bg-emerald-950/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-lg animate-ios-spring">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-400 text-white flex items-center justify-center shadow-md shadow-emerald-500/20 font-black text-sm">
              #{activeStudent.code}
            </div>
            <div>
              <div className="text-xs font-bold text-emerald-800 dark:text-emerald-300 flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4" />
                <span>حساب الطالب مسجل ومحفوظ على هذا الجهاز</span>
              </div>
          ...
          <Link
            href="/student"
            className="w-full sm:w-auto px-5 py-2.5 rounded-2xl bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white font-black text-xs transition flex items-center justify-center gap-2 shadow-md"
          >
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#060e22] via-[#091638] to-[#040817] text-white p-8 sm:p-14 shadow-2xl border border-white/10">
        <div className="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-brand-500/25 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/10 text-cyan-200 text-xs font-bold backdrop-blur-md">
            <Sparkles className="w-3.5 h-3.5 text-cyan-300" />
            <span>المنصة الرقمية الأولى لمادة العلوم المتكاملة • الصف الأول الثانوي</span>
          </div>
          ...
          <p className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-2xl font-normal">
            منظومة ذكية تجمع بين كارت الهوية الرقمي (Apple Wallet Pass) بتقنية الـ QR فائق السرعة، متابعة الحضور والغياب، الاشتراكات الشهرية، ورصد درجات الامتحانات بضغطة زر.
          </p>

          <div className="flex flex-wrap gap-3.5 pt-2">
            <Link
              href="/register"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-black text-sm shadow-xl shadow-emerald-500/25 transition active:scale-95"
            >
            ...
            <Link
              href="/student"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold text-sm backdrop-blur-md transition active:scale-95"
            >
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 flex items-center justify-center group-hover:scale-110 group-hover:bg-emerald-600 group-hover:text-white transition-all shadow-xs">
        ...
        >
          <div className="space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-brand-50 dark:bg-brand-950/60 text-brand-600 dark:text-cyan-400 flex items-center justify-center group-hover:scale-110 group-hover:bg-brand-600 group-hover:text-white transition-all shadow-xs">
      ...
      <section className="rounded-3xl liquid-glass p-8 sm:p-10 space-y-6">
        <div className="text-center max-w-xl mx-auto space-y-1">
          <h3 className="text-xl font-black text-slate-900 dark:text-white">تجربة تعليمية متكاملة واحترافية</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-slate-700 dark:text-slate-300">
          <div className="p-5 rounded-2xl bg-white/70 dark:bg-slate-900/70 border border-white/60 dark:border-slate-800 shadow-xs flex items-start gap-3.5">
